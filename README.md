# Project
Build a RAG using TypeSense Cloud to search faster and efficiently from the input documents provided.
...
Key Features
    ...
    Advanced Search: Supports filtering, faceting, geo-search, and vector search (for semantic similarity).
    Real-time Indexing: Updates search indexes almost instantly. 
